...
| :---:   | :---: | :---: |
| **Scripts** | uses shell script to make batch file to run job(s) [click here to see sbatch run file](https://github.com/pallavig702/Kuberneters-vs-Slurm-/blob/main/SLURM)
| uses YAML files to run a job(s)|
