...
| :---:   | :---: | :---: |
| **Scripts** | uses shell script to make batch file to run job(s) ([click here to see sbatch run file gpu_job.sh](https://github.com/pallavig702/Kuberneters-vs-Slurm-/blob/main/SLURM/gpu_job.sh) ) | uses YAML files to run a [pod](https://github.com/pallavig702/Kuberneters-vs-Slurm-/blob/main/Kubernetes/CreatePod.yml) or [job(s)](https://github.com/pallavig702/Kuberneters-vs-Slurm-/blob/main/Kubernetes/CreatePod.yml)|
